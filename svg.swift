...
// svg([version(), width(300), height(200), xmlns()],)
 /*
 <rect x="10" y="10" width="30" height="30" stroke="black" fill="transparent" stroke-width="5"/>
  */
//rect([x(10), y(10), width(300), height(200),stroke("black"),fill("transparent"),  strokeWidth(5)])
/*
 ...
 */
//polyline(<#T##attrs: [(String, String)]##[(String, String)]#>)
/*
